...
* [IdentityServer](http:\\localhost\dncIds)
* [Asp.NET](http:\\localhost\DNCAspNet)
* [Asp.NET Core](http:\\localhost\DNCAspNetCore)

## Allgemein
* [Sample GITHub Repository](https://github.com/rlfkrl/NetCologne2017)
